...
header("Content-Security-Policy: default-src 'self'; img-src https://cvchd.doh.gov.ph/noncomis/public; style-src 'self' 'nonce-$nonce' 'unsafe-inline' https://fonts.googleapis.com; script-src 'self' 'nonce-$nonce'; object-src 'none'; font-src 'self' https://fonts.gstatic.com; frame-ancestors 'self'; form-action 'self';");

header('X-XSS-Protection: 1; mode=block');
// Set X-Frame-Options header
//header("X-Frame-Options: SAMEORIGIN");

// Set Accept header for application/json
// header("Accept: application/json");

// header("Set-Cookie: myCookie=value; SameSite=Strict; Secure; HttpOnly;");
